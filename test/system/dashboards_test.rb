...
class DashboardsTest < ApplicationSystemTestCase
  ...
  test "should create dashboard" do
    ...
    fill_in "Appointment", with: @dashboard.Appointment
    fill_in "Doctor", with: @dashboard.Doctor
    fill_in "Patient", with: @dashboard.Patient
    fill_in "Staff", with: @dashboard.Staff
