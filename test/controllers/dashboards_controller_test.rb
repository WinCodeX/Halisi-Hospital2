...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference("Dashboard.count") do
      post dashboards_url, params: { dashboard: { Appointment: @dashboard.Appointment, Doctor: @dashboard.Doctor, Patient: @dashboard.Patient, Staff: @dashboard.Staff } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { Appointment: @dashboard.Appointment, Doctor: @dashboard.Doctor, Patient: @dashboard.Patient, Staff: @dashboard.Staff } }
